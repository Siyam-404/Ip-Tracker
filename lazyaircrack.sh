...
banner () {        ##### Banner #####
echo -e "${Red}
.M"""bgd `7MMF'`YMM'   `MM'      db      `7MMM.     ,MMF'
,MI    "Y   MM    VMA   ,V       ;MM:       MMMb    dPMM  
`MMb.       MM     VMA ,V       ,V^MM.      M YM   ,M MM  
  `YMMNq.   MM      VMMP       ,M  `MM      M  Mb  M' MM  
.     `MM   MM       MM        AbmmmqMA     M  YM.P'  MM  
Mb     dM   MM       MM       A'     VML    M  `YM'   MM  
P"Ybmmd"  .JMML.   .JMML.   .AMA.   .AMMA..JML. `'  .JMML."
